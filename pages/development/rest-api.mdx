...
We can use tools such as [Postman](https://www.postman.com/) to call the REST-API URL. To access ROQ BaaS REST API, we need a token for request authorization using **Bearer Token**.
