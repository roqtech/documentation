...
The code tells us to query the book count data in descending order. This code will translated to the REST API call:
...
There are a few ways to get the user token. You can get it manually for fast testing and development, or you can get the token programmatically.
