...
### Create a custom application 
    ...
    Create a custom application using one of the supported frameworks. For example, to create a Next.js application, run the following command:
...
### Copy `.env`
    ...
    Copy the environment values from ROQ Console into the `.env` file in the custom application.
