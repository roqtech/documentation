...
For example, the `@roq/nextjs` package is the SDK for the Next.js framework. If you want to use it with your Next.js application, please refer to the [**Quickstart**](/next-js/quickstart) documentation.
