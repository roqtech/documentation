...
ROQ SDK, for the client side, can be integrated into various web frameworks like Next.js, Nuxt.js, RedwoodJS, and SvelteKit. For a practical example of file upload using Next.js, please read the documentation on [add file uploads](/tutorials/add-file-uploads).
