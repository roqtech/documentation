...
You can utilize the `signIn` and `signOut` methods from the `roqBrowserClient` factory that live in the `src/lib/roq/roq-client.ts"`. To use it you must import it first:
