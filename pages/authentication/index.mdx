...
ROQ provides a complete and secure authentication and user management solution for your generated application. In case you are running an application, then check out our [integration guide](/authentication/advanced-topics/integration-guide) how to use it.
...
- [Customize the managed login and registration pages](/authentication/registration-form)
