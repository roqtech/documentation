...
Other than the default registration form, you can create registration form variant. This type of form is needed if you need to display custom form to the user for specific business case.
