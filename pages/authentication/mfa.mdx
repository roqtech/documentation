...
The next step is to enable MFA on the registration or login form in the ROQ Console. Go to the **Authentication** → **Configuration**. You can enable MFA for each registration form variant by selecting the **Two-factor Authentication** flag.
