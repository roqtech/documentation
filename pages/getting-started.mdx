...
## (1) Install ROQ package from NPM

You can install ROQ’s SDK by running this NPM command:
...
Please create a free account here: https://console.roq.tech and get your environment credentials.
...
Before using ROQ’s feature, you need to synchronize some of your user data. This data is needed for two purposes
...
ℹ️ See Create users API for more information.
@TODO - Add link
...
🎉🎉🎉🎉🎉 That’s it! Now you are ready to select one of the UI components and to implement and business logic based on ROQ!