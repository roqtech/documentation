...
1. The [**`<Chat/>`**](/chat/chat) UI component represents the chat message center with sidebar and the chat
   window.
2. The [**`<MessageBell/>`**](/chat/chat-message-bell) component renders an icon symbol which informs the user
