...
| `isGroup`   | Boolean?  | Usually set to true when you have three or more participants or when you need to have a named title for a conversation between 2 participants |
| `memberIds` | string[]! | An array of userIds for participants of the conversation                                                                                   |
| `ownerId`   | string!   | The userId of the owner - i.e. usually the creator who has permission to archive the conversation                                          |
