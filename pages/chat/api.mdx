...
Delete a conversation for a specific ID. The API documenation for `deleteConversation()` is [here](https://jupiter-pp.roq-platform.com/docs/#mutation-deleteConversation).
