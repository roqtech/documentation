...
<Callout type="info" emoji="ℹ️">
  Don't update your project to the `1.0.1` versions of the NPM libraries as long
  as your project wasn't migrated to the Jupiter instance. If you are still on
  Mars instance, contact us via slack for migration.
</Callout>

| Library                                                        | Purpose                           | New Version | Migration |
| -------------------------------------------------------------- | --------------------------------- | ----------- | --------- |
| [`@roq/ui-react`](https://www.npmjs.com/package/@roq/ui-react) | UI Components for React           | `1.0.1`     | none      |
| [`@roq/nextjs`](https://www.npmjs.com/package/@roq/nextjs)     | UI Components and SDK for Next.js | `1.0.1`     | none      |
| [`@roq/nodejs`](https://www.npmjs.com/package/@roq/nodejs)     | Backend SDK for Node.js           | `1.0.1`     | none      |
...
```bash
npm install "@roq/ui-react@^1.0.1" --save
```

**Yarn**

```bash
yarn upgrade "@roq/ui-react@^1.0.1"
```
...
```bash
npm install "@roq/nodejs@^1.0.1" --save
```

**Yarn**

```bash
yarn upgrade "@roq/nodejs@^1.0.1"
```
