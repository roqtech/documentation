...
<Callout type="info" emoji="ℹ️">
  Tenants can be created automatically when users are signing up OR manually
  created or assigned via API.
</Callout>
...
![roles-tenant-name](public/screenshots/rolesTenantName.jpg)
