...
<Callout type="info">
ROQ Platform already provides email templates for *user invitation mail*, *reset password mail*, and *email confirmation* for usage such as registration confirmation. 
</Callout>
...
Go to **Transactional Mails** → **Templates** to edit existing templates or create a new template with customized locales.

![Create email templates](/create-email-templates.png)

To create a new email template, click **+ Create Mail Template** button and then set these required keys:

* **Unique Key**: This is the key used to send email in code.
* **Select Locale**: The email locale template.
* **Subject**: The email subject.
* **Content**: The email content.

![Create email template](/create-email-template-edit.png)
...
The email content support locales, read about this in this [documentation](/mails/tutorials/create-email-locales). 