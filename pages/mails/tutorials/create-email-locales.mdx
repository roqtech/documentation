...
The email content supports any locales. By default, there are two locales supported: `English, United State en-US` and `Germany, de-DE`. To create additional locales to the application, please read this [documentation](/translations).
