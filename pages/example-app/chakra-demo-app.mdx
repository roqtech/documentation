...
There are two login options: **Login as a School Administrator** and **Login as a Freelance Educator**. These two type of login options are generated based on the user roles you have selected in the user setup wizard. Feel free to explore the demo app and develop your own application using our Backend as a Service (BaaS) platform.

## Next steps

- [Using BaaS with Next.js](/next-js#create-a-nextjs-application)
