...
There are two login options: **Login as a School Administrator** and **Login as a Freelance Educator**. These two type of login options are generated based on the user roles you have selected in the user setup wizard.
