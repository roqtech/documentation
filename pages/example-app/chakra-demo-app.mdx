...
After app generation is complete, you will receive an email with a link to the project console. In this project console, you can manage your users and fine-tune all configurations.
