...
Translations are managed via the [ROQ Console](https://console.roq.tech/). All components are already translated. Therefore
...
You can manage locales in the [ROQ Console](https://console.roq.tech/). When you add a new locale, then you'll need to add
