...
Every schema has an entity called `user` that represents any user, regardless of the role. In addition, a table represents the tenant. For example, A restaurant is represents the tenant and the table is called **restaurant**.
