...
To notify your users you can use the [notify() API](/api-doc/notifications-api#notify). It's important to  
use the same `key` which you set to the notification template.
