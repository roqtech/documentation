...
perform. This is typically achieved through roles and permissions, which grant different access levels to other users.
...
complicated WHERE conditions, especially if you have more than these two simple roles.
