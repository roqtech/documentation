...
<Callout type="info">
For tutorial on how to assign or unassign roles from a user using ROQ's Node.js SDK API, read this [tutorial](/access-management/tutorials/user-roles-assignment).
</Callout>
