...
<Callout type="info">
To run a local development for the generated application, please refer to this [docoumentation](/development-guides/run-local-development).
</Callout>
...
Query plans is cached locally. Please refer to  the [cache the qury plans](/access-management/tutorials/cache-query-plans) tutorial on how to do that.