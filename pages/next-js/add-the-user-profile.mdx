...
<Callout type="info">
Please note that the 'userProfile()' method is part of the ROQ platform API and cannot be generated. However, you can still update user profile data in the ROQ Console.
</Callout>
