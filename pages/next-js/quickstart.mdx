...
Other than the ROQ BaaS SDK, Next.js also need generated customized SDK. To generate this SDK, run the command below:

```shell
npx @roq/cli generate
```

The default location for the generated SDK is `src/lib/roq`.
