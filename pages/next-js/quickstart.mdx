...
export default function Home() {
  ...
  return (
    <div className=" flex w-full h-screen justify-center items-center inline-flex">
      <div className="flex flex-col justify-start items-center gap-[34px] inline-flex">
        <div className="text-white text-[32px] font-bold font-['Satoshi Variable'] leading-[38.40px] tracking-tight">Welcome</div>
        <div className="justify-center items-start gap-3 inline-flex">
          <div className="px-[18px] py-1.5 bg-indigo-500 rounded shadow flex-col justify-center items-center inline-flex">
            <div className="justify-center items-center gap-1 inline-flex">
              <button onClick={handleSignIn} className="text-white text-[15px] font-bold font-['Satoshi Variable'] leading-relaxed tracking-wide">Sign in</button>
            </div>
          </div>
          <div className="px-[18px] py-1.5 bg-indigo-500 rounded shadow flex-col justify-center items-center inline-flex">
            <div className="justify-center items-center gap-1 inline-flex">
              <button onClick={handleSignUp} className="text-white text-[15px] font-bold font-['Satoshi Variable'] leading-relaxed tracking-wide">Sign up</button>
            </div>
          </div>
        </div>
      </div>
...
- [How to query data with filters](/next-js/accessing-the-data)
- How to save data
