...
Go to the [project console](https://console.roq.tech/) and select the project and the environment then copy the environment values from the console. For local development, we can use the `Local Development` environment.
