...
It is recommended that you start by reading the [Quickstart](/next-js) guide to set up a new Next.js project. Additionally, you can wrap the main component on the Next.js page with `RoqProvider` to enable page authentication.
