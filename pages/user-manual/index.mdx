...
Here you can see a visualization of the underlying data model of your app. If you want to change it, you can either adopt the schema file of Prisma or regenerate your application.
