...
the [files feature guide](/files) for more information and instructions. You can see this component in action on
...
uploaded. Please refer to the [files feature guide](/files) for more information and instructions. See this component in
action on [Storybook](https://ui.roq.tech/?path=/docs/files-fileupload--default).
...
[Storybook](https://ui.roq.tech/?path=/docs/files-fileactiveuploads--default).
