...
[createFileUpload() API](/files/api#createfileupload). The upload is realized using _**signed URLs**_, which means the files are uploaded directly from the user's browser to the object storage without sending it through your backend.
