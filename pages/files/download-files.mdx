...
There are two methods to download files in the ROQ platform. The first method involves using API, while the second method involves downloading files directly from the ROQ Console. However, the latter method is restricted to administrators or users who have access to the ROQ Console.
