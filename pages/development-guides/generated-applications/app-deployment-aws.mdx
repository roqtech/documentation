...
ROQ-generated applications, by default, are using PostgreSQL as the database. We will create this in Amazon RDS. There are a few steps to create and set up a PostgreSQL database:
