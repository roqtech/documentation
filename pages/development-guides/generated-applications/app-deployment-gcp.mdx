...
We can form the PostgreSQL URI from the earlier steps to connect our generated application.


```shell
DATABASE_URL=psql "postgresql://owner:crypt1ck!m0sab3@34.28.181.197:5432/animefiguredb"
```
