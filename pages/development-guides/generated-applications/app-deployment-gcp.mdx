...
Create environment `.env` file if don't exist in the generated application then copy all the environment variables from the ROQ Console and add the `DATABASE_URL` for our PostgreSQL database:
