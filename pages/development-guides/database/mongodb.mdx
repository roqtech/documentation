...
This documentation explains how to integrate ROQ's generated application with MongoDB and install it on different operating systems and container-based solutions such as Docker.
...
{/*
Linked to ather section that handle database creation
*/}
...
{/*
Convert Prisma Schema from PostgreSQL to MongoDB
*/}