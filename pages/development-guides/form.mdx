...
The book data is displaying in the Book list. To show book `description` on the list, you need to change `BookViewPage` component in `pages\books\edit` directory.
