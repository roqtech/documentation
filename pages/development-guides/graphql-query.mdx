...
You can access this API as either a Super Admin or a regular User. For more information, please refer to the [user vs superadmin](/development-guides/sdk-api#user-vs-superadmin) section of the SDK API documentation.