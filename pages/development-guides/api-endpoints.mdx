...
In ROQ's generated B2B SaaS application, the data fetching is very easy with the help of [`swr`](https://swr.vercel.app/) package. First, for the better application management, you can create a React `Hello` component in `components/hello` directory, give it a name `index.tsx`
...
After that you can check again the URL [`http://localhost:3000/hello`](http://localhost:3000/hello) to see the changes
