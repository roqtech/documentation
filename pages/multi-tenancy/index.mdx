...
ROQ offers simple APIs for managing tenant data, including creation, updates, and querying. For API documentation and code samples, visit [Multi-tenancy api](/multi-tenancy/api).
