...
are two approaches: You can overwrite the CSS directly or inject an entirely new theme.
</Callout>
...
To get a template for your theme, visit Storybook, select a UI component and click on “Theme”:
