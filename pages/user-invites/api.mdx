...
(e.g. The [**`<UserInvitesTable/>`**](/user-invites/ui-components#userinvitestable-)). However, you can also use it
programmatically.
...
You can find the full API doc of this mutation [here](https://jupiter-pp.roq-platform.com/docs/#mutation-sendUserInvites).
