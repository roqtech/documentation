...
You can use the user invite API with ROQ notification system. The use case here is, for example, to send a user a notification after accept the invitation. For detail on how to do this please look into this [tutorial](/user-invites/tutorials/user-invites-with-notify).
