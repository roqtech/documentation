...
To add a new notification in the ROQ-generated application, check out the docs [here](/notifications/tutorials/add-notifications).

## How to Trigger a Notification

Triggering or testing a notification can be done via a GraphQL API query. See this doc for details [here](/notifications/tutorials/test-notification).

## UI Components

ROQ provides multiple Notification UI components  which can be integrated into your application. See this doc for details [here](/notifications/ui-components).
