...
[🎬 Video tutorial](/notifications/video)
...
[ROQ Console](https://console.roq.tech/).
...
You can manage new notification templates in [ROQ Console](https://console.roq.tech/). Each template requires a unique
