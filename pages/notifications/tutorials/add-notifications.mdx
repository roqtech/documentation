...
To test the notification read this [tutorial](/notifications/tutorials/test-notification) and if you want to learn more about the Notification API, please go [here](/notifications/api).
