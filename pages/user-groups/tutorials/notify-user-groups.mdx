...
<Callout type="info">
To add new notification template in the ROQ Console, please read this  [add notifications](/notifications/tutorials/add-notifications) tutorial.
</Callout>

For example to send a notification for group **Video Creator** which have a group id `42103455-1e00-41bf-9714-c70a8c17caf9`:
...
If you loggin as a user with member of group **Video Creator** in the generated application, you will receive the notification
