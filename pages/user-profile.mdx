...
{/*
To update the user profile information, you can use the `updateUserProfile()` function. This function need the user profile object as parameter. The user profile object is the same as the object returned by the `userProfile()` API.
