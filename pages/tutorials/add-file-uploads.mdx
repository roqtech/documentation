...
ROQ SDK for Next.js also provides a `FileUpload` component to make the file upload easy to code. Let's take an example of how to upload an image file using ROQ BaaS.
