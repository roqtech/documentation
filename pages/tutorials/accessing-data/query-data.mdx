...
This tutorial will guide you to query from ROQ BaaS database using ROQ generated SDK on client side. All database operation such as read and write data can be done through `useRoqClient()` method.
...
There are two kind of query data in ROQ BaaS: query data without filters and query data with filters.
