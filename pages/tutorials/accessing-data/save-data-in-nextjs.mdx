...
To create a new application you need to have a ROQ Console account. If you don't have one, please sign up an account at [ROQ Console](https://console.roq.tech). Read this [guide](/example-app#generate-app) to learn how to create an application. 
...
We need to create a registration form variant for the **Business Owner** and **Freelancer** roles. 
...
Please note that each roles will have different registration form variants. This make sure that the user will be able to register or signin with the correct role.
...
The last one is to configure the project schema. Again, make sure to publish any changes.
...
Read this [Next.js quickstart](/next-js#create-a-nextjs-application) guide to initialize the Next.js application with signup, login, and logout features.
