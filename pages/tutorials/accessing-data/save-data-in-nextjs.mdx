...
For further development, we should create another clean Next.js application outside the ROQ Console. Read this [Next.js quickstart](/next-js#create-a-nextjs-application) guide to initialize the Next.js application with signup, login, and logout features.
