...
For now we can only check the response data from the browser console. We will add a list of projects in the next section.

The response data from the browser console:
